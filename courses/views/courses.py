...
# previous implementation for courses list
...
def coursePage(request, slug):
    ...
    try:
        ...
        error_message = "Sorry, the requested video does not exist."
        return render(request,"courses/page_not_found.html", {'error_message': error_message})
